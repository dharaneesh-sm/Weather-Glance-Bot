...
const storage = {} //This object will keep track of the state of the conversation with each user
...
bot.onText(/\/start/, (msg) => {
  ...
  bot.sendMessage(
    chatId,
    'Hello! 🌤️ This bot is your go-to for weather and time updates worldwide! Ready to get started? Choose an option below:',
    {
      reply_markup: {
        inline_keyboard: [
...
bot.on('callback_query', async (callbackQuery) => {
  ...
  switch (data) {
    case 'get_weather':
      ...
      bot.sendMessage(
        chatId,
        'Please enter the name of the city 🏙️ or send /stop to cancel:'
      )
      break
    case 'get_time':
